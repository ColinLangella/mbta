...
class BadRequest(BaseModel):
    ...
    """ # noqa: E501
    errors: Annotated[List[BadRequestErrorsInner], Field(min_length=1, max_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [BadRequestErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
