...
class ActivePeriod(BaseModel):
    ...
    """ # noqa: E501
    start: Optional[datetime] = Field(default=None, description="Start Date. Format is ISO8601.")
    end: Optional[datetime] = Field(default=None, description="End Date. Format is ISO8601.")
